function [Osc] = Mean2Osc_thirdbody(Mean, Kepler_thirdbody)
...
e = sqrt(1-Osc_lp(5)^2/Osc_lp(4)^2);
E = Kepler_Eqn_solver(Osc_lp(1), e, 10^-9);
dWdx_SP(1) = dWdl_SP(a_, r_, l_, Osc_lp(2), Osc_lp(3), Osc_lp(4), Osc_lp(5), Osc_lp(6), E);
dWdx_SP(2) = dWdg_SP(a_, r_, l_, Osc_lp(2), Osc_lp(3), Osc_lp(4), Osc_lp(5), Osc_lp(6), E);
dWdx_SP(3) = dWdh_SP(a_, r_, l_, Osc_lp(2), Osc_lp(3), Osc_lp(4), Osc_lp(5), Osc_lp(6), E);
dWdx_SP(4) = dWdL_SP(a_, r_, l_, Osc_lp(2), Osc_lp(3), Osc_lp(4), Osc_lp(5), Osc_lp(6), E);
dWdx_SP(5) = dWdG_SP(a_, r_, l_, Osc_lp(2), Osc_lp(3), Osc_lp(4), Osc_lp(5), Osc_lp(6), E);
dWdx_SP(6) = dWdH_SP(a_, r_, l_, Osc_lp(2), Osc_lp(3), Osc_lp(4), Osc_lp(5), Osc_lp(6), E);
